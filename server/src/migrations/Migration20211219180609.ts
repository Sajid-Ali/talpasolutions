...
export class Migration20211219180609 extends Migration {
  async up(): Promise<void> {
    ...
    this.addSql(
      'alter table "sensor" add constraint "sensor_machine_id_foreign" foreign key ("machine_id") references "sensor" ("id") on update cascade;'
    );
  }
}
